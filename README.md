...
[https://github.com/leandrocgsi/microservices-with-spring-cloud-and-java-erudio](https://github.com/leandrocgsi/microservices-with-spring-cloud-and-java-erudio)
...
Este é o repositório legado dos códigos fonte desenvolvidos no curso [Formação Microsserviços 2026: do Zero ao Deploy na Google Cloud com Spring Boot, Kubernetes e Docker](https://pub.erudio.com.br/formacao-microsservicos-2026-do-zero-ao-deploy-na-google-cloud-com-spring-boot-kubernetes-e-docker?utm_source=github&utm_medium=organic&utm_campaign=readme&utm_content=repo-oficial-legacy)
